...
| Lệnh | Chức năng |
|------|-----------|
| `/slack-monitoring:once` | Kiểm tra đề cập một lần |
...
📢 Theo kênh (nhiều đề cập nhất)
| Kênh       | Đề cập | Phản hồi |
|-----------|--------|----------|
| #dev      | 12     | 92%      |
| #general  | 8      | 100%     |

👥 Theo người gửi (nhiều đề cập nhất)
| Người gửi  | Đề cập | Phản hồi |
|-----------|--------|----------|
| Minh       | 7      | 100%     |
| Lan        | 5      | 80%      |
```
...
| **Mô hình tóm tắt** | Haiku, Sonnet, Phiên hiện tại | Haiku |

<details>
<summary>Định dạng file cấu hình</summary>
